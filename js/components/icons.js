 ...
 * Keeps icon markup consistent and avoids duplication across components.
 */
...
const PATHS = {
  ...
  roster: '<rect x="3" y="3" width="18" height="18" rx="3"/><circle cx="9" cy="9" r="2"/><path d="m21 15-4-4L6 21"/>',
  settings:
  ...
  rest: '<path d="M3 18v-5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v5"/><path d="M3 18h18"/><path d="M6 11V8a2 2 0 0 1 2-2h2"/>',
  ...
  palette:
    '<circle cx="13.5" cy="6.5" r=".6"/><circle cx="17.5" cy="10.5" r=".6"/><circle cx="8.5" cy="7.5" r=".6"/><circle cx="6.5" cy="12.5" r=".6"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"/>',
  ...
  whatsapp:
    '<path d="M12 3.5a8.5 8.5 0 0 0-7.3 12.8L3.5 20.5l4.3-1.1A8.5 8.5 0 1 0 12 3.5Z"/><path d="M9 10.3c0-.5.3-.8.7-1l.5-.3c.3-.1.6 0 .8.2l.7.8c.2.2.1.5-.1.7l-.2.2c.4.8 1.1 1.5 1.9 1.9l.2-.2c.2-.2.5-.3.7-.1l.8.7c.2.2.3.5.2.8l-.3.5c-.2.4-.6.7-1 .7-2.6 0-4.9-2.3-4.9-5.2Z"/>',
  eitaa: '<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/><path d="M8 9h8M8 13h5"/>',
  phone:
  ...
  holiday: '<path d="M4 22V3"/><path d="M4 3h14l-2.4 3L18 9H4"/>',
...
export function icon(name, className = "") {
  ...
  return `<svg class="icon ${className}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${paths}</svg>`;
}
