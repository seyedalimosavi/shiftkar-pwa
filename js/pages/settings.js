...
const HELP_ITEMS = [
  ...
  {
    title: "تعطیلات",
    body: "دادهٔ تعطیلات این نسخه، مجموعهٔ نمونه (غیررسمی) از چند تعطیل ثابت هجری شمسی است و مرجع رسمی ندارد؛ به همین دلیل نباید آن را فهرست کاملی از تعطیلات رسمی دانست.",
  },
];
